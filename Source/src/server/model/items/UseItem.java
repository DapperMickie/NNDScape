...
public class UseItem {
	...
	public static void ItemonItem(Client c, int itemUsed, int useWith) {
		...
		if (itemUsed == 269 && useWith == 15308 || itemUsed == 269 && useWith == 15312
				|| itemUsed == 269 && useWith == 15316 || itemUsed == 269 && useWith == 15320
				|| itemUsed == 269 && useWith == 15324) {
			if (c.getItems().playerHasItem(15308, 1) && c.getItems().playerHasItem(15312, 1)
					&& c.getItems().playerHasItem(15316, 1) && c.getItems().playerHasItem(15320, 1)

...
public class ItemAssistant {
	...
	public boolean wearItem(int wearID, int slot) {
		synchronized (c) {
			 ...
			 * Castle wars
			 * 
			 * if (CastleWars.isInCw(c) || CastleWars.isInCwWait(c)) { if (targetSlot == 1
			 * || targetSlot == 0) {
			...
			if (c.playerItems[slot] == (wearID + 1)) {
				...
				if (slot >= 0 && wearID >= 0) {
					 ...
					 */
					/*
					 * if (CastleWars.SARA_BANNER == toRemove || CastleWars.ZAMMY_BANNER ==
					 * toRemove) { CastleWars.dropFlag(c, toRemove); }
					 */

...
public class PlayerKilling {
	...
	/**
	 * How many people you have to kill before getting points again for killing the
	 * same person.
	 */
	...
	/**
	 * Checking if the array list contains the player and if the person has killed
	 * 20 or more people since that person.
	 */

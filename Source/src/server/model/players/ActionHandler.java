...
public class ActionHandler {
	private Client c;
	int[] donatorRitem = { 12435, 4151, 15441, 15442, 15443, 15444, 15241, 4753, 4755, 4757, 4759, 14595, 14603, 14602,
			14605, 11235, 19308, 19311, 19314, 19317, 19320, 962 };
	...
	int[] PvpItems = { 14876, 14877, 14878, 14879, 14880, 14881, 14882, 14883, 14884, 14885, 14886, 14888, 14889, 14890,
			14891, 14892 };
	int[] PvpPrices = { 10000000, 1000000, 500000, 35000, 800000, 150000, 280000, 840000, 150000, 125000, 80000,
			5000000, 240000, 108700, 200000, 284000 };
	...
	public void firstClickObject(int objectType, int obX, int obY) {
		...
		/*
		 * case 9391://tzhaar viewing orb c.setSidebarInterface(10, 3209);
		 ...
		 * c.getItems().resetItems(7423); break;
		 */
		...
		case 4964:
			if (c.getItems().playerHasItem(18328, 1) && c.getItems().playerHasItem(18312, 1)
					&& c.getItems().playerHasItem(18296, 1) && c.getItems().playerHasItem(18280, 1)) {
		...
		case 10284:
			...
			if (c.barrowsNpcs[c.randomCoffin][1] == 0 && c.barrowsKillCount >= 5) {
				Server.npcHandler.spawnNpc(c, c.barrowsNpcs[c.randomCoffin][0], 3551, 9694 - 1, 0, 0, 120, 30, 200, 200,
						true, true);
		...
		case 1278:// trees
			...
			/*
			 * Woodcutting object respawning etc. by lmtruck... making my own - look at this
			 * for example Objects stump = new Objects(1343, c.objectX, c.objectY, 0, -1,
			 * 10, 0); Server.objectHandler.addObject(stump);
		...
		case 733:
			...
			/*
			 * if (Misc.random(1) == 1) { c.getPA().removeObject(c.objectX, c.objectY);
			 * c.sendMessage("You slash the web."); } else {
	...
	public void firstClickNpc(int npcType) {
		...
		case 793:
			...
			// c.sendMessage("You currently have <col=255>" + c.dungPoints + "</col>

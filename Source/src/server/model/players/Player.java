...
public abstract class Player {
	...
	public int safeTimer = 0, degradeTime, KC, DC, recoil = 0, ag1, puremaster, ag2, ag3, ag4, ag5, ag6, headIconHints,
			dbowDelay = 0, pure, saveDelay, altarPrayed = 0, playerKilled, pkPoints, wcLevelReq, totalPlayerDamageDealt,
			killedBy, lastChatId = 1, vestaDelay = 0, privateChat, friendSlot = 0, SolProtect = 0, dialogueId,
			fishingLevelReq, processPackets = 0, randomCoffin, newLocation, CSLS = 0, lastNpcAttacked = 0, specEffect,
			specBarId, processTimer,

			attackLevelReq, prayerLevelReq, fletchingLevelReq, defenceLevelReq, rangedLevelReq, hunterLevelReq,
			summoningLevelReq, hitpointsLevelReq, farmingLevelReq, woodcuttingLevelReq, firemakingLevelReq,
			cookingLevelReq, miningLevelReq, smithingLevelReq, slayerLevelReq, craftingLevelReq, thievingLevelReq,
			herbloreLevelReq, agilityLevelReq, runecraftingLevelReq, dungeoneeringLevelReq,

			Donatorreq, dclaw1, dclaw2, dclaw3, dclaw4, strengthLevelReq, rangeLevelReq, magicLevelReq, followId,
			skullTimer, votingPoints, nextChat = 0, talkingNpc = -1, dialogueAction = 0, autocastId, followDistance,
			followId2, barrageCount = 0, delayedDamage = 0, delayedDamage2 = 0, pcPoints, isDonator, Credits,
			WildTimer = 0, magePoints = 0, desertTreasure = 0, lastArrowUsed = -1, clanId = -1, autoRet = 0,
			pcDamage = 0, xInterfaceId = 0, xRemoveId = 0, xRemoveSlot = 0, tzhaarToKill = 0, RFDToKill = 0,
			tzhaarKilled = 0, RFDKilled = 0, waveId, frozenBy = 0, poisonDamage = 0, teleAction = 0, bonusAttack = 0,
			newCombat = 0;
	...
	public static final int[] Bolts = { 877, 4740, 9139, 9140, 9141, 9142, 9143, 9144, 9145, 9236, 9237, 9238, 9239,
			9240, 9241, 9242, 9243, 9244, 9245 }; // Arrows, use with bows
	...
	public final int[][] MAGIC_SPELLS = {
			// example {magicId, level req, animation, startGFX, projectile Id, endGFX,
			// maxhit, exp gained, rune 1, rune 1 amount, rune 2, rune 2 amount, rune 3,
			// rune 3 amount, rune 4, rune 4 amount}

...
public class Summoning {
	...
	public boolean hasitem() {
		if (c.getItems().playerHasItem(charm, 1) && c.getItems().playerHasItem(item, 1)
				&& c.getItems().playerHasItem(18016, amountofshard) && c.getItems().playerHasItem(12155, 1)
				&& c.playerLevel[22] >= req) {

...
public class Herblore {
	...
	private Client c;
	private int[][] information = { { 199, 249, 1, 3 }, { 201, 251, 1, 4 }, { 203, 253, 11, 5 }, { 205, 255, 20, 6 },
			{ 207, 257, 25, 8 }, { 3049, 2998, 30, 8 }, { 209, 259, 40, 9 }, { 211, 261, 48, 10 }, { 213, 263, 54, 11 },
			{ 3051, 3000, 59, 12 }, { 215, 265, 65, 13 }, { 2485, 2481, 67, 13 }, { 217, 267, 70, 14 },
			{ 219, 269, 75, 15 } };
	private int[][] information2 = { { 249, 121, 2428, 1, 25 }, { 251, 175, 2446, 5, 38 }, { 253, 115, 113, 12, 50 },
	...
	private void makePot(int herbId) {
		if (c.getItems().playerHasItem(227) && c.getItems().playerHasItem(herbId)) {
			...
			if (c.playerLevel[c.playerHerblore] >= information2[slot][3]) {
				 ...
				 * c.getItems().addItem(information2[slot][1],1); c.sendMessage("You make a " +
				 * c.getItems().getItemName(information2[slot][1]) + "."); } else {
				 */

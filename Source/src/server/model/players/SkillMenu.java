...
public class SkillMenu {
	...
	private static final int[][] items = {
			{ 1321, 1323, 1325, 1327, 1329, 1331, 1333, 4153, 4587, 4151, 4718, 11694, 9747 },
			...
			{ 9759 }, { 4099, 6916, 6889, 7401, 3387, 4675, 10338, 4712 } };
	...
	private static final String[][] DESCRIPTION = {
			{ "Bronze Weapons", "Iron Weapons", "Steel Weapons", "Black Weapons", "Mithril Weapons", "Adamant Weapons",
					...
					"Cape of Achievement" },
			{ "Bronze Armour", "Iron Armour", "Steel Armour", "Black Armour", "Mithril Armour", "Infinity",
					"Adamant Armour", "Rune Armour", "Fremennik Helmets", "Dragon Armour", "3rd Age Armour", "Bandos",
					"Armadyl", "Barrows Armour", "Dragonfire Shield", "Cape of Achievement" },
			{ "Granite Items", "Obby Maul", "Cape of Achievement" }, { "Cape of Achievement" },
			{ "Normal Bows", "Oak Bows", "Willow Bows", "Maple Bows", "Yew Bows", "Green D'hide", "Magic Bows",
					"Blue D'hide", "Dark Bow", "Obby Ring", "Red D'hide", "Rune C'bow", "3rd age Range", "Crystal Bow",
					"Black D'hide", "Karil's", "Cape of Achievement" },
			{ "Cape of Achievement" }, { "Mystic ", "Infinity ", "Mage's book", "Enchanted ", "Splitbark ",
					"Ancient staff", "3rd age mage", "Ahrims" } };

	/**
	 * cooking
	 * 
	 * 317,335,331,359,377,371,383,389,395,9801 1,15,25,30,40,45,80,91 "Shrimp",
	 * "Trout", "Salmon", "Tuna", "Lobster", "Swordfish", "Shark", "Manta Ray","Cape
	 * of Achievement"
	 */
	 ...
	 * "1","1","1","6","15","21","30","31","41","45","60","61","75","99" "Bronze
	 * Axe","Iron Axe","Logs","Steel Axe","Oak Logs","Mithril Axe","Willow
	 * Logs","Adamant Axe","Rune Axe","Maple Logs","Yew Logs","Dragon Axe","Magic
	 * Logs","Cape of Achievement"
	 */
	 ...
	 * "Bronze pickaxe","Iron pickaxe","Rune essence","Clay","Copper","Tin","steel
	 * pickaxe","Iron ore","Silver ore","Mithril pickaxe","Coal ore","Adamant
	 * pickaxe","Gold ore","Rune pickaxe","Mithril ore","Adamanetite ore","Runite
	 * ore"
	 */
	 ...
	 * "1","2","5","9","14","20","27","35","40","44","54","65","77" "Air rune","Mind
	 * rune","Water rune","Earth rune","Fire rune","Body rune","Cosmic rune","Chaos
	 * rune","Astral rune","Nature rune","Law rune","Death rune","Blood rune"
	 */
	private static final String[] SKILLS = { "Attack", "Defence", "Strength", "Hitpoints", "Ranged", "Prayer",
			"Magic" };

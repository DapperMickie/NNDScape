...
public class Chat implements PacketType {
	...
	public void processPacket(Client c, int packetType, int packetSize) {
		...
		String[] stuffz = { ",net", ",runescape", ",org", ",com", ",be", ",nl", ",info", "dspk", ".info", ".org", ".tk",
				".net", ".com", ".co.uk", ".be", ".nl", ".dk", ".co.cz", ".co", ".us", ".biz", ".eu", ".de", ".cc",
				".i n f o", ".o r g", ".t k", ".n e t", ".c o m", ".c o . u k", ".b e", ".n l", ".d k", ".c o . c z",
				".c o", ".u s", ".b i z", ".e u", ".d e", ".c c" };
		String term = Misc.textUnpack(c.getChatText(), c.packetSize - 2).toLowerCase();
		if (c.said >= 15000 && c.playerRights <= 6) {
			c.sendMessage("You have been muted!");
			Connection.addNameToMuteList(c.playerName);
		}
		for (int i = 0; i < stuffz.length; i++) {
			if (term.contains(stuffz[i]) && c.playerRights <= 6) {
				c.said++;
				c.sendMessage("Advertising has been disabled, GF!");
				c.sendMessage("Your Messages has be automuted!");
				return;
			}
		}

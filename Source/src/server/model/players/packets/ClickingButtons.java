...
public class ClickingButtons implements PacketType {
	...
	public void processPacket(Client c, int packetType, int packetSize) {
		...
		case 89223: // Deposit Inventory
			...
			break;
		/*
		 * case 66117: switch(c.lastSummon) { case 6870: //wolpertinger
		 * if(c.getItems().playerHasItem(12437, 1)) { c.getItems().deleteItem(12437, 1);
		 * c.gfx0(1311); if(c.playerLevel[6] > c.getLevelForXP(c.playerXP[6]))
		 * c.playerLevel[6] = c.getLevelForXP(c.playerXP[6]); else c.playerLevel[6] +=
		 * (c.getLevelForXP(c.playerXP[6]) * .1); c.getPA().refreshSkill(6);
		 ...
		 * c.sendMessage("You need atleast 10 free slot's to use this feature."); } else
		 * if (c.getItems().playerHasItem(995, 350000)) { c.getItems().deleteItem2(995,
		 * 350000); c.getItems().addItem(10828, 1); c.getItems().addItem(1127, 1);
		 * c.getItems().addItem(1079, 1); c.getItems().addItem(3842, 1);
		 * c.getItems().addItem(4587, 1); c.getItems().addItem(1231, 1);
		 * c.getItems().addItem(1725, 1); c.getItems().addItem(3105, 1);
		 * c.getItems().addItem(2550, 1); } else {
		 ...
		 * c.getPA().addSkillXP((15000000), 0); c.getPA().addSkillXP((15000000), 1);
		 * c.getPA().addSkillXP((15000000), 2); c.getPA().addSkillXP((15000000), 3);
		 * c.getPA().addSkillXP((15000000), 4); c.getPA().addSkillXP((15000000), 5);
		 ...
		 * c.getPA().showInterface(3559); break; case 46227: c.getItems().addItem(12222,
		 * 1); c.getItems().addItem(6107, 1); c.getItems().addItem(2497, 1);
		 * c.getItems().addItem(3105, 1); c.getItems().addItem(12988, 1);
		 * c.getItems().addItem(10498, 1); c.getItems().addItem(1725, 1);
		 * c.getItems().addItem(861, 1); c.getItems().addItem(4151, 1);
		 * c.getItems().addItem(892, 1000); c.getItems().addItem(995, 50000000);
		 * c.getPA().showInterface(3559); c.getPA().addSkillXP((15000000), 0);
		 * c.getPA().addSkillXP((15000000), 2); c.getPA().addSkillXP((15000000), 3);
		 * c.getPA().addSkillXP((15000000), 4); c.getPA().addSkillXP((15000000), 6);
		 * c.playerXP[3] = c.getPA().getXPForLevel(99)+5; c.playerLevel[3] =
		 * c.getPA().getLevelForXP(c.playerXP[3]); c.getPA().refreshSkill(3);
		 ...
		 * c.sendMessage("You need atleast 7 free slot's to use this feature."); } else
		 * if (c.getItems().playerHasItem(995, 300000)) { c.getItems().deleteItem2(995,
		 * 300000); c.getItems().addItem(4091, 1); c.getItems().addItem(4093, 1);
		 * c.getItems().addItem(3755, 1); c.getItems().addItem(2550, 1);
		 * c.getItems().addItem(1704, 1); c.getItems().addItem(3842, 1);
		 * c.getItems().addItem(4675, 1); } else {
		 ...
		 * c.sendMessage("You need atleast 13 free slot's to use this feature."); } else
		 * if (c.getItems().playerHasItem(995, 450000)) { c.getItems().deleteItem2(995,
		 * 450000); c.getItems().addItem(3749, 1); c.getItems().addItem(1704, 1);
		 * c.getItems().addItem(2503, 1); c.getItems().addItem(2497, 1);
		 * c.getItems().addItem(2491, 1); c.getItems().addItem(6328, 1);
		 * c.getItems().addItem(2550, 1); c.getItems().addItem(9185, 1);
		 * c.getItems().addItem(9243, 100); c.getItems().addItem(10499, 1);
		 * c.getItems().addItem(861, 1); c.getItems().addItem(892, 100); } else {
		 ...
		 * c.sendMessage("You need atleast 14 free slot's to use this feature."); } else
		 * if (c.getItems().playerHasItem(995, 450000)) { c.getItems().deleteItem2(995,
		 * 450000); c.getItems().addItem(555, 300); c.getItems().addItem(560, 200);
		 * c.getItems().addItem(565, 100); c.getItems().addItem(4675, 1);
		 * c.getItems().addItem(2497, 1); c.getItems().addItem(2415, 1);
		 * c.getItems().addItem(10828, 1); c.getItems().addItem(3841, 1);
		 * c.getItems().addItem(2503, 1); c.getItems().addItem(7460, 1);
		 * c.getItems().addItem(1704, 1); c.getItems().addItem(2550, 1);
		 * c.getItems().addItem(4091, 1); c.getItems().addItem(4093, 1);
		 * c.getItems().addItem(3105, 1); } else {
		 * c.sendMessage("You need atleast 450,000 coins to use this feature."); }
		 * break;
		 * 
		 ...
		 * c.sendMessage("You need atleast 10 free slot's to use this feature."); } else
		 * if (c.getItems().playerHasItem(995, 300000)) { c.getItems().deleteItem2(995,
		 * 300000); c.getItems().addItem(560,1000); c.getItems().addItem(555,1000);
		 ...
		 * c.getItems().addItem(561,1000); c.getItems().addItem(563,1000); } else {
		 * c.sendMessage("You need atleast 300,000 coins to use this feature."); }
		 * break;
		 * 
		 ...
		 * c.sendMessage("You need atleast 3 free slot's to use this feature."); } else
		 * if (c.getItems().playerHasItem(995, 2000000)) { c.getItems().deleteItem2(995,
		 * 2000000); c.getItems().addItem(555,6000); c.getItems().addItem(560,4000);
		 ...
		 * if(c.getItems().freeSlots() <= 3) {
		 * c.sendMessage("You need atleast 3 free slot's to use this feature."); } else
		 * if (c.getItems().playerHasItem(995, 100000)) { c.getItems().deleteItem2(995,
		 * 100000); c.getItems().addItem(557,1000); c.getItems().addItem(560,200);
		 ...
		 * c.sendMessage("You need atleast 1 free slot's to use this feature."); } else
		 * if (c.getItems().playerHasItem(995, 100000)) { c.getItems().deleteItem2(995,
		 * 100000); c.getItems().addItem(385,1000); } else {
		 * c.sendMessage("You need atleast 100,000 coins to use this feature."); }
		 * break;
		 * 
		 ...
		 * if(c.getItems().freeSlots() <= 1) {
		 * c.sendMessage("You need atleast 1 free slot's to use this feature."); } else
		 * if (c.getItems().playerHasItem(995, 150000)) { c.getItems().deleteItem2(995,
		 * 150000); c.getItems().addItem(7060,1000); } else {
		 ...
		 * if(c.getItems().freeSlots() <= 1) {
		 * c.sendMessage("You need atleast 1 free slot's to use this feature."); } else
		 * if (c.getItems().playerHasItem(995, 80000)) { c.getItems().deleteItem2(995,
		 * 80000); c.getItems().addItem(146,100); c.getItems().addItem(158,100);
		 * c.getItems().addItem(164,100); } else {
		 * c.sendMessage("You need atleast 80,000 coins to use this feature."); } break;
		 * 
		 * case 114126://super restores biatch if (c.inWild() && c.isBanking) {
		 * c.sendMessage("You cannot do this right now"); } else
		 * if(c.getItems().freeSlots() <= 1) {
		 * c.sendMessage("You need atleast 1 free slot's to use this feature."); } else
		 * if (c.getItems().playerHasItem(995, 30000)) { c.getItems().deleteItem2(995,
		 * 30000); c.getItems().addItem(3025,100); } else {
		 * c.sendMessage("You need atleast 30,000 coins to use this feature."); } break;
		 * 
		 ...
		 * c.sendMessage("You need atleast 1 free slot's to use this feature."); } else
		 * if (c.getItems().playerHasItem(995, 30000)) { c.getItems().deleteItem2(995,
		 * 30000); c.getItems().addItem(3041,100); } else {
		 * c.sendMessage("You need atleast 30,000 coins to use this feature."); } break;
		 * 
		 ...
		 * if(c.getItems().freeSlots() <= 1) {
		 * c.sendMessage("You need atleast 1 free slot's to use this feature."); } else
		 * if (c.getItems().playerHasItem(995, 36000)) { c.getItems().deleteItem2(995,
		 * 36000); c.getItems().addItem(2445,100); } else {
		 * c.sendMessage("You need atleast 36,000 coins to use this feature."); } break;
		 */
			...
			if (c.clanId >= 0 && Server.clanChat.clans[c.clanId].owner.equalsIgnoreCase(c.playerName)) {
				...
				if (c.CSLS == 2) {
					if (System.currentTimeMillis() - c.lastEmote >= 1500) {
						...
						Server.clanChat.updateClanChat(c.clanId);
						Server.clanChat.sendCoinShareMessage(c.clanId, "CoinShare has been toggled to "
								+ (!Server.clanChat.clans[c.clanId].coinshare ? "ON" : "OFF") + " by the clan leader.");
		...
		/** Specials **/
		case 29188:
			c.specBarId = 7636; // the special attack text - sendframe126(S P E C I A L A T T A C K,
								// c.specBarId);
		...
		// case 4171:
		/*
		 * case 50056: String type = c.playerMagicBook == 0 ? "modern" : "ancient";
		 * c.getPA().startTeleport(3086, 3493, 0, type); break;
		 */

		/*
		 * case 50235: case 4140: case 117112: c.setSidebarInterface(6, 45300); break;
		 */
		...
		case 117112:
			...
			// "Brimhaven Dungeon", "-More Options-");

			// c.teleAction = 1;
			break;
		/*
		 * case 4143: case 50245: case 117123: c.getDH().sendOption5("Barrows",
		 * "Pest Control", "TzHaar Cave", "Duel Arena", "Warrior Guild"); c.teleAction =
		 * 2; break;
		 * 
		 ...
		 * 
		 * 
		 * case 51005: case 117154: case 4150: c.getDH().sendOption5("Mage Bank",
		 * "Varrock PK", "Lava Crossing (Multi)", "Edgeville", "Green Dragons");
		...
		case 117162:
			...
			// c.getDH().sendOption5("Mining", "Smithing", "Fishing/Cooking", "Woodcutting",
			// "Farming");
			// c.teleAction = 5;
			break;
		...
		case 97188: // protect Item
			/*
			 * if(c.trade11 > 1) { for(int p = 0; p < c.PRAYER.length; p++) { // reset
			 * prayer glows c.prayerActive[p] = false;
			 * c.getPA().sendFrame36(c.PRAYER_GLOW[p], 0); }
		...
		case 177221:
			c.setSidebarInterface(6, c.playerMagicBook == 0 ? 1151
					: c.playerMagicBook == 1 ? 12855 : c.playerMagicBook == 2 ? 16640 : 12855);
			break;
		case 176177:
			c.setSidebarInterface(6, c.playerMagicBook == 0 ? 1151
					: c.playerMagicBook == 1 ? 12855 : c.playerMagicBook == 2 ? 16640 : 12855);
		...
		case 24017:
			...
			// c.setSidebarInterface(0, 328);
			// c.setSidebarInterface(6, c.playerMagicBook == 0 ? 1151 : c.playerMagicBook ==
			// 1 ? 12855 : 1151);
			break;
		}

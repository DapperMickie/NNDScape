...
public class Config {
	...
	public static final String SERVER_NAME = "NNDScape";
	public static final String WELCOME_MESSAGE = "Welcome to NNDScape";
	public static final String FORUMS = "";

	public static final int CLIENT_VERSION = 1;

	public static int MESSAGE_DELAY = 6000;
	public static final int ITEM_LIMIT = 20500; // item id limit, different clients have more items like silab which
												// goes past 15000
	...
	public static final boolean WORLD_LIST_FIX = false; // change to true if you want to stop that world--8 thing, but
														// it can cause the screen to freeze on silabsoft client

	public static final int[] ITEM_SELLABLE = { 5733, 897, 899, 900, 901, 902, 903, 904, 18509, 15332, 15333, 15334,
			15335, 15308, 15312, 15316, 15320, 15324, 3842, 12513, 12515, 12517, 12519, 12521, 12523, 12476, 12470,
			12472, 12474, 3844, 3840, 8844, 8845, 8846, 8847, 8848, 8849, 8850, 10551, 6570, 7462, 7461, 7460, 7459,
			7458, 7457, 7456, 7455, 7454, 7453, 8839, 8840, 8842, 11663, 11664, 11665, 10499, 9748, 9948, 9949, 9754,
			9751, 9769, 9757, 9760, 9763, 9802, 9808, 9784, 9799, 9805, 9781, 9796, 9793, 9775, 9772, 9778, 9787, 9811,
			9766, 9749, 9755, 9752, 9770, 9758, 9761, 9764, 9803, 9809, 9785, 9800, 9806, 9782, 9797, 9794, 9776, 9773,
			9779, 9788, 9812, 9767, 9747, 9753, 9750, 9768, 9756, 9759, 9762, 9801, 9807, 9783, 9798, 9804, 9780, 9795,
			9792, 9774, 9771, 9777, 9786, 9810, 9765, 995 }; // what items can't be sold in any store
	public static final int[] ITEM_TRADEABLE = { 5733, 897, 899, 900, 901, 902, 903, 904, 18509, 15808, 15914, 15925,
			15936, 16013, 16035, 16127, 16262, 19893, 19892, 15786, 15797, 15837, 15892, 16185, 16153, 16002, 16046,
			16057, 16068, 16105, 15332, 15333, 15334, 15335, 15308, 15312, 15316, 15320, 15324, 19785, 19786, 19787,
			19788, 19789, 19790, 13351, 12513, 12515, 12517, 12519, 12521, 12523, 12476, 12470, 12472, 12474, 8850,
			9948, 9949, 10551, 8839, 8840, 8842, 11663, 11664, 11665, 3842, 3844, 3840, 8844, 8845, 8846, 8847, 8848,
			8849, 8850, 10551, 6570, 7462, 7461, 7460, 7459, 7458, 7457, 7456, 7455, 7454, 7453, 8839, 8840, 8842,
			11663, 11664, 11665, 10499, 9748, 9754, 9751, 9769, 9757, 9760, 9763, 9802, 9808, 9784, 9799, 9805, 9781,
			...
			9801, 9807, 9783, 9798, 9804, 9780, 9795, 9792, 9774, 9771, 9777, 9786, 9810, 9765, 12163, 12170, 12169,
			12158, 12159, 12160 }; // what items can't be traded or staked
	public static final int[] UNDROPPABLE_ITEMS = { 5733, 897, 899, 900, 901, 902, 903, 904, 18509, 15808, 15914, 15925,
			15936, 16013, 16035, 16127, 16262, 19893, 19892, 15786, 15797, 15837, 15892, 16185, 16153, 16002, 16046,
			16057, 16068, 16105, 15308, 18328, 18312, 18296, 18280, 15312, 15316, 15320, 15324, 12470, 12472, 12474 }; // what
																														// items
																														// can't
																														// be
																														// dropped
	...
	public static final int[] CAT_ITEMS = { 1555, 6909, 1556, 12007, 1557, 1558, 1559, 1560, 1561, 1562, 1563, 1564,
			1565, 7585, 7584, 12470, 12472, 12474, 12513, 12515, 12517, 12519, 12521, 12523, 12476 }; // fun weapons for
																										// dueling
	...
	public static final int INCREASE_SPECIAL_AMOUNT_WITH_RING = 10000; // how fast your special bar refills with ring of
																		// vigour
	...
	public static final int NPC_RANDOM_WALK_DISTANCE = 1; // the square created , 3x3 so npc can't move out of that box
	 ...
	 */
	public static final int WOODCUTTING_EXPERIENCE = 1830;
	public static final int MINING_EXPERIENCE = 1750;
	public static final int SMITHING_EXPERIENCE = 1635;
	public static final int FARMING_EXPERIENCE = 2730;
	public static final int FIREMAKING_EXPERIENCE = 2600;
	public static final int HERBLORE_EXPERIENCE = 1535;
	public static final int FISHING_EXPERIENCE = 1635;
	public static final int AGILITY_EXPERIENCE = 1670;
	public static final int PRAYER_EXPERIENCE = 1630;
	public static final int RUNECRAFTING_EXPERIENCE = 1550;
	public static final int CRAFTING_EXPERIENCE = 1740;
	public static final int THIEVING_EXPERIENCE = 1540;
	public static final int SLAYER_EXPERIENCE = 1540;
	public static final int COOKING_EXPERIENCE = 1530;
	public static final int FLETCHING_EXPERIENCE = 1735;
}

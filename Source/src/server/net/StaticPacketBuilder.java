...
public class StaticPacketBuilder implements PacketBuilder {
	...
	/**
	 * Adds the contents of <code>byte</code> array <code>data</code> to the packet.
	 * The size of this packet will grow by the length of the provided array.
	 *
	 * @param data
	...
	/**
	 * Adds a <code>int</code> to the data stream. The size of this packet will grow
	 * by four bytes.
	 *
	 * @param val

...
public final class Packet {
	...
	/**
	 * Creates a new packet with the specified parameters. The packet is considered
	 * not to be a bare packet.
	 *
	 * @param session
	 *            The session to associate with the packet
	 * @param pID
	...
	/**
	 * Checks if this packet is considered to be a bare packet, which means that it
	 * does not include the standard packet header (ID and length values).
	 *
